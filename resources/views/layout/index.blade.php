        ...
        <div class="flex-w flex-sb-m p-b-52">
            ...
            <div class="dis-none panel-search w-full p-t-10 p-b-15">
                <div class="bor8 dis-flex p-l-15">
                    <form style="display: flex;" action="{{URL::to('/search')}}" method="POST">
                        @csrf   
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="uploads/{{$val->image}}" alt="IMG-PRODUCT">

                        <a style="text-decoration: none" href="{{URL::to('/product-detail', $val->id)}}"  id="view" data-id="{{$val->id}}"  class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                            Xem sản phẩm
                        </a>
                    </div>
