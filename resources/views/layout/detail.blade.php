            ...
            <div class="row">
                        ...
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                @foreach ($imgProduct as $val)
                                    <div class="item-slick3" data-thumb="uploads/{{$val->name}}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="uploads/{{$val->name}}" alt="IMG-PRODUCT">
                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="uploads/{{$val->name}}">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <form action="{{URL::to('/addToCart', $product->id)}}" method="POST">
                            <div class="p-t-33">
                                    ...
                                    <div class="size-204 respon6-next">
                                        <div class="rs1-select2 bor8 bg0">
                                            <select class="js-select2" name="size">
                                                @foreach ($size as $val)
                                                    <option value="{{$val->value}}">Size {{$val->value}}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="flex-w flex-r-m p-b-10">
                                    <div class="size-204 flex-w flex-m respon6-next">
                                            ...
                                            <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                                ...
                                                <input type="hidden" name="number_db" value="{{$product->number}}">
                                                <input class="mtext-104 cl3 txt-center num-product" name="quantity" type="number" min="1" name="num-product" value="1">
                                            ...
                                            @else
                                                <img style="width: 150px;" src="uploads/sold_out11.png" alt="Hết hàng">
                                            @endif
                                    </div>
                                </div>
                            </div>
